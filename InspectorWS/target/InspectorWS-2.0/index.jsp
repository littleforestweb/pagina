    ...
    <body>
        ...
        <div id="overlay">
            <div id="overlay_text">
                ...
                <div class="spinner-border"></div><br>Please Wait
            </div>
        </div>
        <!-- END OVERLAY -->
        ...
        <div class="sidebar-nav bg-light">
            ...
            <a href="https://littleforest.co.uk" target="_blank">
                <img class="sidebar-logo" alt="sidebar Logo" src="https://littleforest.co.uk/wp-content/uploads/2020/11/littleforest_logo.png">
            </a>
            ...
            <ul id="links-section" class="sidebar-list">
                ...
                <div id="links-div" hidden>
                    <li id="links-li">
                        <p>Found <span id="totalLinks">0</span> link(s) (<span id="extLinks">0</span> external and <span id="intLinks">0</span> internal)
                        </p>
