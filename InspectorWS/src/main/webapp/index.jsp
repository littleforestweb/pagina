        ...
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-sm text-center">
                            <button class="bg-transparent border-0" onclick="selectUserReviewer(this)">
                                <img width="100px" src="images/usersIcons/boy.png" alt="Responsive image">
                                <p>Gavin</p>
                            </button>
                        </div>
                        <div class="col-sm text-center">
                            <button class="bg-transparent border-0" onclick="selectUserReviewer(this)">
                                <img width="100px" src="images/usersIcons/gamer.png" alt="Responsive image">
                                <p>Joao</p>
                            </button>
                        </div>
                        <div class="col-sm text-center">
                            <button class="bg-transparent border-0" onclick="selectUserReviewer(this)">
                                <img width="100px" src="images/usersIcons/woman.png" alt="Responsive image">
                                <p>Billy</p>
                            </button>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="h-100 input-group-text">Comments</span>
                    </div>
...
<nav class="lf-topnav navbar navbar-expand navbar-light bg-light shadow">
    ...
    <a class="navbar-brand text-center" href="https://littleforest.co.uk" target="_blank">
        <img height="32" src="images/littleforest_logo.png" alt="Little Forest Logo">
    </a>
